...
extern sm_element *sm_insert(register sm_matrix *A, int row, int col),
...
extern int sm_col_dominance(sm_matrix *A, int *weight);
extern int sm_block_partition(sm_matrix *A, sm_matrix **L, sm_matrix **R);
